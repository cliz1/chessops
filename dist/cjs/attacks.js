...
const royalpainterAttacks = (square, occupied) => (0, exports.bishopAttacks)(square, occupied).xor((0, exports.rookAttacks)(square, occupied));
...
const rollingsnareAttacks = (square, occupied) => (0, exports.queenAttacks)(square, occupied);
...
const attacks = (piece, square, occupied) => {
    switch (piece.role) {
        ...
        case 'royalpainter':
            return (0, exports.royalpainterAttacks)(square, occupied);
        case 'rollingsnare':
            return (0, exports.rollingsnareAttacks)(square, occupied);
    }
};
