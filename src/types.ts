...
export const ROLE_CHARS = ['q', 'n', 'r', 'b', 'p', 'k', 'c', 'i', 'a', 'm', 'y', 's', 'w', 'x', 'o'] as const;
...
export const ROLES = ['pawn', 'knight', 'bishop', 'rook', 'queen', 'king', 'champion', 'princess', 'amazon', 'commoner', 'painter', 'snare', 'wizard', 'archer', 'royalpainter'] as const;
